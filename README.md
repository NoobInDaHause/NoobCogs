...
| ----------------- | --------- | ------------------------------------------------------------ |
| Afk               |  v1.6.12  | Notify users whenever you go AFK with pings logging.         |
| AutomaticReaction |  v1.0.6   | Automatic emoji reactions.                                   |
| CookieClicker     |  v1.2.3   | Play a cookie clicker.                                       |
