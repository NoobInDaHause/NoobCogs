...
| DonationLogger   |  v1.2.5   | Donation Logger system.                                     |
| GlobalBan        |  v1.2.1   | Globally ban a user from all the guilds the bot is in.      |
| GrinderLogger    |  v1.1.1   | GrinderLogger system.                                       |
...
| ServerDonations  |  v3.1.8   | Donate bot currencies or any other currencies to servers.   |
