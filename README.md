...
| ---------------- | --------- | ----------------------------------------------------------- |
| Afk              |  v1.5.0   | Notify users whenever you go AFK with pings logging.        |
...
| DonationLogger   |  v1.0.15  | Donation Logger system.                                     |
...
| NoobTools        |  v1.0.2   | NoobInDahause's personal tools.                             |
| PressF           |  v1.1.8   | F.                                                          |
