...
| GlobalBan       |  v1.2.2   | Globally ban or unban a user from guilds the bot is in.          |
| ManagerUtils    |  v2.2.0   | Some utility commands that are useful for managers from servers. |
