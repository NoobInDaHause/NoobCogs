...
| ----------------- | --------- | ------------------------------------------------------------ |
| Afk               |  v1.6.13  | Notify users whenever you go AFK with pings logging.         |
| AutomaticReaction |  v1.0.7   | Automatic emoji reactions.                                   |
| CookieClicker     |  v1.2.4   | Play a cookie clicker.                                       |
