...
class CookieClickerView(nu.NoobView):
    def __init__(
        self, context: nu.Context, cog: "CookieClicker", timeout: float = 60.0
    ):
    ...
    @nu.discord.ui.button(emoji="✖️", label="Quit", style=nu.get_button_colour("danger"))
    async def quit(self, interaction: nu.Interaction, button: nu.discord.ui.Button):
        """Quit cookie clicker."""
