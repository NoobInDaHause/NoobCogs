...
class Calculator(discord.ui.View):
    ...
    async def one(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await self.message.edit(content=box(merged, "py"))
        
    @discord.ui.button(label="2", style=discord.ButtonStyle.grey, row=2)
    ...
    @discord.ui.button(label="Exit", style=discord.ButtonStyle.danger, row=5)
    ...
    @discord.ui.button(label="4", style=discord.ButtonStyle.grey, row=6)
    ...
    @discord.ui.button(label="5", style=discord.ButtonStyle.grey, row=7)
    ...
    @discord.ui.button(label="6", style=discord.ButtonStyle.grey, row=8)
    ...
    @discord.ui.button(label="-", style=discord.ButtonStyle.blurple, row=9)
    ...
    @discord.ui.button(label="\u232B", style=discord.ButtonStyle.danger, row=10)
    ...
    @discord.ui.button(label="7", style=discord.ButtonStyle.grey, row=11)
    ...
    @discord.ui.button(label="8", style=discord.ButtonStyle.grey, row=12)
    ...
    @discord.ui.button(label="9", style=discord.ButtonStyle.grey, row=13)
    ...
    @discord.ui.button(label="*", style=discord.ButtonStyle.blurple, row=14)
    ...
    @discord.ui.button(label="Clear", style=discord.ButtonStyle.danger, row=15)
    async def clear(self, interaction: discord.Interaction, button: discord.ui.Button):
        """Clear"""
        self.value_list.clear()
        await self.message.edit(content=box("0", "py"))
        
    @discord.ui.button(label="00", style=discord.ButtonStyle.grey, row=16)
    ...
    @discord.ui.button(label="0", style=discord.ButtonStyle.grey, row=17)
    ...
    @discord.ui.button(label=".", style=discord.ButtonStyle.grey, row=18)
    ...
    @discord.ui.button(label="/", style=discord.ButtonStyle.blurple, row=19)
    ...
    @discord.ui.button(label="=", style=discord.ButtonStyle.success, row=20)
    async def equals(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await self.message.edit(content=box(final, "py"))
