...
class RainbowRole(commands.Cog):
    ...
    async def rainbowroleset_reset(self, context: commands.Context):
        ...
        """
        act = "Successfully resetted the guilds rainbowrole settings."
        conf = "Are you sure you want to reset the guilds rainbowrole settings?"
    ...
    async def rainbowroleset_resetcog(self, context: commands.Context):
        ...
        """
        act = "Successfully resetted the rainbowrole cogs config."
        conf = "Are you sure you want to reset the rainbowrole cogs whole config?"
        view = Confirmation(timeout=30)
        await view.start(context=context, confirmation_msg=conf, confirm_action=act)
